    ...
    return (
      <section className="bg-services-bg-img">
        <div className="xl:mt-20 mt-10 xl:w-[80%] lg:w-[90%] md:w-[95%] w-11/12 mx-auto">
          <h1 className="text-black font-medium xl:text-5xl lg:text-4xl text-2xl mb-14 mt-16 xl:my-20">Global - Couriers</h1>
          <div className="grid md:grid-cols-3 grid-cols-2 xl:gap-20 lg:gap-14 sm:gap-10 gap-5">
            {company.map(com => {
                return (
                  <div key={com.src} className="flex shadow-md shadow-paragraph sm:py-5 sm:px-6 py-3 px-3">
