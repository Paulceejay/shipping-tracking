  ...
  return (
    <div className="bg-secondaryColor">
      <div className="xl:w-[80%] lg:w-[90%] md:w-[95%] w-11/12 mx-auto md:py-14 py-7">
        <h1 className="mt-7 mb-2 mx-2 text-lg sm:text-xl lg:text-3xl font-bold text-white">International Package</h1>
        <h1 className="mb-7 mt-2 mx-2 text-lg sm:text-xl lg:text-3xl font-bold text-white">Tracking Couriers</h1>
        ...
        <div className="flex sm:w-1/2 w-10/12">
          <small className="mr-5 text-white sm:text-sm text-xs">VIEW ALL CARRIERS</small>
