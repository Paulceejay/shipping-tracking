    ...
    <div className="xl:w-[80%] lg:w-[90%] md:w-[95%] w-11/12 mx-auto lg:my-40 my-20">
      <div className="flex md:flex-row flex-col-reverse">
        ...
        <div className="xl:w-[70%] lg:w-[50%] md:w-1/2 md:ml-7">
          ...
          <h2 className="text-headerColor font-bold md:text-2xl text-lg lg:mb-6 md:mb-3">
            1300+ CARRIERS SUPPORTED FOR MILLIONS OF USERS
          </h2>
          <p className="my-3 text-paragraph xl:text-2xl text-base">
      ...
      <div className="md:flex flex-nowrap grid md:mt-0 mt-4">
        <p className="bg-secondaryColor opacity-40 xl:text-xl md:text-lg text-lg text-white xl:w-1/2 md:w-[50%] w-full xl:py-9 py-5 md:px-4 px-2 md:mr-5 shadow-sm shadow-paragraph col-span-12">
          We have long standing business relationshipswith some of the world’s
          largest agency.
        </p>
        <div className="bg-secondaryColor xl:py-9 py-6 xl:px-14 lg:px-8 md:px-5 px-2 text-white md:w-auto md:mx-5 shadow-md shadow-paragraph col-span-6 md:m-0 my-4 mr-2">
        ...
        <div className="bg-white xl:py-9 py-6 xl:px-14 lg:px-8 md:px-5 px-2 md:w-auto md:mx-5 shadow-lg shadow-paragraph col-span-6 md:m-0 my-4 ml-2">
