const ContactBgImage = () => {
  return (
    <div className="w-full bg-contact-bg-img h-full bg-no-repeat bg-cover bg-center bg-blend-darken filter brightness-[80%]">
      <div className="xl:pt-24 xl:pb-32 pt-16 pb-28 bg-gradient-to-r from-gradientTwo bg-blend-darken">
        <div className="lg:pt-28 xl:w-[85%] lg:w-[95%] lg:max-w-none xs:max-w-[685px] w-11/12 mx-auto flex justify-between md:flex-row flex-col">
