    ...
    return (
      <div className="xl:pt-24 xl:pb-32 pt-16 pb-28 xl:w-[90%] lg:w-[95%] md:w-[95%] w-11/12 mx-auto flex justify-between">
        ...
        <div className="w-full lg:w-1/2 mt-10">
          <p className="text-center xl:text-4xl text-2xl lg:w-10/12 mx-auto">
            Enter your user Email and password to log in
          </p>
          <Link
            className="xl:text-4xl text-lg flex justify-center items-center text-secondaryColor py-10 font-bold underline"
            href="/auth/sign-up"
          >
            Create Account
          </Link>
          <form action="" className="w-full lg:w-10/12 mx-auto">
            <div className="w-full">
              ...
              <Link
                className="xl:text-2xl text-lg flex justify-center items-center text-secondaryColor py-10 font-bold underline"
